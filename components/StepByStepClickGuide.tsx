...
export const StepByStepClickGuide: React.FC<StepByStepClickGuideProps> = ({
  ...
  return (
    <div className="rounded-3xl border border-indigo-500/30 bg-gradient-to-r from-slate-950 via-indigo-950/40 to-slate-950 p-6 shadow-2xl space-y-5 animate-in fade-in">
      
      {/* Header Title */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-indigo-900/40 pb-4">
        <div className="flex items-center space-x-3">
          <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-indigo-500/20 text-indigo-300 border border-indigo-500/40 shadow-lg shadow-indigo-500/20">
        ...
        {actionDoneMsg && (
          <span className="rounded-xl bg-emerald-950 px-3 py-1.5 text-xs font-bold text-emerald-300 border border-emerald-800 animate-in fade-in">
            {actionDoneMsg}
          </span>
        )}
      </div>
        ...
        return (
          <div className="rounded-2xl border border-slate-800 bg-slate-900/90 p-5 space-y-4 shadow-xl">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-800 pb-3">
              <div className="flex items-center space-x-3">
                <div className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-gradient-to-r ${current.color} text-white shadow-md`}>
